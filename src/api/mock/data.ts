...
export const mockConversations: Conversation[] = [
  ...
  },
  {
    ...
    unreadCount: 1,
    awaitingReply: true,
    sharedInterests: ["настолки", "музыка"],
    lastMessageFromMe: false,
  },
  {
    id: "c3",
    ...
    unreadCount: 0,
    awaitingReply: false,
    sharedInterests: ["бег", "путешествия"],
  ...
  },
  {
    ...
    lastMessage: "",
    lastMessageAt: "2026-08-16T09:50:00.000Z",
    unreadCount: 0,
    awaitingReply: false,
    sharedInterests: ["книги", "театр", "рисование"],
    lastMessageFromMe: false,
  },
];
...
export const mockMessages: Message[] = [
  ...
  },
  {
    ...
    conversationId: "c3",
    authorId: "u4",
    text: "Спасибо за рекомендацию пространства",
