...
const steps = [
  {
    ...
    text: "Профиль собирается в диалоге: имя, возраст 18+, намерения, интересы и ценности.",
  },
  {
    title: "Фото и видео-интро",
    text: "Главное фото становится аватаром, видео — основой для проверки подлинности.",
  },
  {
    title: "Подтверждение",
    text: "Почта и телефон подтверждаются кодом, лицо — сверкой кадров видео с фото.",
  },
  {
    title: "Знакомства",
    text: "Ежедневная подборка, чаты с подсказками и пространства по интересам.",
  },
];
